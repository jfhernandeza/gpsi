 ...
 * @author juan
 */
public class gpsiWEKARandomForestClassificationAlgorithm extends gpsiClassificationAlgorithm {
    ...
    public void fit(HashMap<Byte, ArrayList<double[]>> x) {
        ...
        try {
            ...
            Logger.getLogger(gpsiWEKARandomForestClassificationAlgorithm.class.getName()).log(Level.SEVERE, null, ex);
        }
